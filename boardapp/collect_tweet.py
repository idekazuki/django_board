...
CK  = "e1z7fsaVipOx6Zd45VV7oL8qz"
CS  = "HifsIP3tU5A9RPODnhJPOc009Zbohn3If1QsF5p3mGXoJXpZ4q"
AT  = "911483274584768513-yoPLQeBlpd261AuLnB7j7nxQo8E0mK8"
ATS = "K3NG0QGTcUiJCq7TfVjhLZAyQgWFH3VgDOZufSKlXuULE"
...
def write_tweet_to_file(timelines, dt):
    ...
    # f = open("/home/ubuntu/environment/mysite/tweet/tweet-" + dt + ".json", "a")
    ...
    for timeline in timelines:
        ...
        user_screen_name = timeline["user_screen_name"],
        )
...
def collect_tweet():
    ...
    max_id = ''
    # 検索ワード
    keyword = 'python exclude:retweets min_retweets:10'
    # ツイート取得対象日
    import datetime

    start_dt = datetime.datetime.now()
    start_dt = str(start_dt).replace("-", "").split(" ")[0]
